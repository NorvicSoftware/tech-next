        ...
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
                ...
                <div className="max-w-7xl mx-auto px-4 py-0 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink href={route('imports.index')} active={route().current('imports.index')}>
                                    Importar
                                </NavLink>
                            </div>
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink href={route('persons.index')} active={route().current('persons.index')}>
                                    Autores
                                </NavLink>
                            </div>
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            {header && (
                <header className="bg-white dark:bg-gray-800 shadow">
                    <div className="max-w-7xl mx-auto py-0 px-4 sm:px-6 lg:px-8">{header}</div>
                </header>
            )}
