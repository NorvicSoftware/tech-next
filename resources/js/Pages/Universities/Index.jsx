                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <table className="min-w-full">
                                <thead className="text-lg">
                                    <tr>
                                        <th className="px-4 py-4 border-b border-gray-500">Universidad</th>
                                        <th className="px-4 py-4 border-b border-gray-500">Teléfono</th>
                                        <th className="px-4 py-4 border-b border-gray-500">Dirección</th>
                                ...
                                <tbody>
                                    {universities.map((university, id) => (
                                        <tr key={university.id}>
                                            ...
                                            <td className="px-4 py-2">{university.address}</td>
